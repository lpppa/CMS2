...
@WebServlet("/articleTypeAdd")
public class ArticleTypeAddAction extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.setAttribute("articleTypePage", "/admin/articleTypeAdd.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(service.articleTypeGet(articleTypeName).isEmpty()){
			service.articleTypeAdd(articleTypeName);
			...
			req.setAttribute("articleTypeAddTips", "该栏目已存在");
			req.setAttribute("adminPage", "/admin/articleTypeManager.jsp");
			req.setAttribute("articleTypePage", "/admin/articleTypeAdd.jsp");
			req.getRequestDispatcher("/admin/maintemp.jsp").forward(req,resp);
		}
